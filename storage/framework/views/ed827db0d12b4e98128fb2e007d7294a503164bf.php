          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="<?php echo e(url('admin/edit-product/'.$productDetails->id)); ?>" name="edit_product" id="edit_product" novalidate="novalidate"><?php echo e(csrf_field()); ?>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="product_color" id="product_color" value="<?php echo e($productDetails->product_color); ?>">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Description</label>
                <div class="controls">
                  <textarea name="description" class="textarea_editor span12" style="width: 50%"><?php echo e($productDetails->description); ?></textarea>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Material & Care</label>
                <div class="controls">
                  <textarea name="care" class="textarea_care span12" style="width: 50%"><?php echo e($productDetails->care); ?></textarea>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  <select name="sleeve" class="form-control">
                    ...
                    <?php $__currentLoopData = $sleeveArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sleeve): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($sleeve); ?>" <?php if(!empty($productDetails->sleeve) && $productDetails->sleeve==$sleeve): ?> selected <?php endif; ?>><?php echo e($sleeve); ?></option>
                ...
                <div class="controls">
                  <select name="pattern" class="form-control">
                    ...
                    <?php $__currentLoopData = $patternArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pattern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($pattern); ?>" <?php if(!empty($productDetails->pattern) && $productDetails->pattern==$pattern): ?> selected <?php endif; ?>><?php echo e($pattern); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>  
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="weight" id="weight" value="<?php echo e($productDetails->weight); ?>">
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  <div id="uniform-undefined">
                    ...
                    <?php if(!empty($productDetails->video)): ?>
                      <input type="hidden" name="current_video" value="<?php echo e($productDetails->video); ?>">
                      <a target="_blank" href="<?php echo e(url('videos/'.$productDetails->video)); ?>">View</a> |
                      <a href="<?php echo e(url('/admin/delete-product-video/'.$productDetails->id)); ?>">Delete</a>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="checkbox" name="feature_item" id="feature_item" <?php if($productDetails->feature_item == "1"): ?> checked <?php endif; ?> value="1">
                </div>
              </div>
              <div class="control-group">
...
<?php echo $__env->make('layouts.adminLayout.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\Brahmastra\trunk\resources\views/admin/products/edit_product.blade.php ENDPATH**/ ?>