...
class IndexController extends Controller
{
    public function index(){
		...
		// Meta tags
		$meta_title = "Brahmastra - Device | Fitness Band";
    	...
    	return view('index')->with(compact('productsAll','categories_menu','categories','banners','meta_title','meta_description','meta_keywords',' $categories'));
