...
Route::group(['middleware' => ['adminlogin']], function () {
	...
	//Route::get('/page/categorys','CategoryController@show1');
...
Route::match(['get','post'],'pages/category','CmsController@show');


Route::match(['get','post'],'pages/category/{id}','CmsController@shows');
Route::match(['get','post'],'/categoryl1','CmsController@shows1');
